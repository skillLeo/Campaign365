...
const styles = StyleSheet.create({
  ...
  panicFabIcon: { fontSize: 18 },
  panicFabTxt:  { color: 'white', fontWeight: '800', fontSize: 15 },
  header: {
  ...
  headerTitle: { color: 'white', fontWeight: '800', fontSize: 20 },
  ...
  gotvToggleTxt: { color: 'white', fontWeight: '900', fontSize: 21 },
  sectionTitle: { color: 'white', fontWeight: '800', fontSize: 20, marginBottom: 12 },
  voterList: {
  ...
  voterAvatarTxt: { color: 'white', fontWeight: '700', fontSize: 18 },
  voterName:  { color: 'white', fontSize: 18, fontWeight: '600', flex: 1 },
  actionBtn: {
  ...
  actionBtnTxt:      { color: 'white', fontSize: 15, fontWeight: '700' },
  ...
  legendTxt:  { color: 'rgba(255,255,255,0.6)', fontSize: 15, fontWeight: '600' },
  targetBox:  { backgroundColor: '#111827', borderRadius: 14, padding: 16, gap: 10 },
  targetTxt:  { color: 'white', fontWeight: '700', fontSize: 18 },
