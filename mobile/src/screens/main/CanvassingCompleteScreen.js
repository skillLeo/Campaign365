...
const styles = StyleSheet.create({
  ...
  logoNum:  { color: 'white', fontWeight: '900', fontSize: 16 },
  ...
  checkMark: { color: 'white', fontSize: 25, fontWeight: '900' },
  subtitle:  { color: 'white', fontSize: 22, fontWeight: '700', width: '100%', textAlign: 'center', marginTop: -8 },
  statsRow: {
  ...
  statIcon:  { fontSize: 25, marginBottom: 6 },
  statLabel: { color: '#64748B', fontSize: 12, textAlign: 'center', marginBottom: 4, lineHeight: 18 },
  statValue: { color: 'white', fontSize: 35, fontWeight: '900' },
  statBar:   { width: '100%', height: 2, backgroundColor: GREEN, borderRadius: 1, marginTop: 8 },
  notesSection: { paddingHorizontal: 20 },
  notesTitle:   { color: 'white', fontSize: 20, fontWeight: '800', marginBottom: 12 },
  noteRow: {
  ...
  noteTxt:   { color: 'white', fontSize: 16, flex: 1, marginRight: 8 },
  noteIcons: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  noteChat:  { fontSize: 18 },
  noteArrow: { color: 'rgba(255,255,255,0.3)', fontSize: 18, fontWeight: '700' },
  ...
  syncBtnTxt:  { color: 'white', fontWeight: '900', fontSize: 21 },
  continueBtn: { paddingVertical: 14, alignItems: 'center' },
  continueTxt: { color: 'rgba(255,255,255,0.6)', fontSize: 19, fontWeight: '600' },
});
